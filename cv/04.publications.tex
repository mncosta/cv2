...
%---------------------------------------------------------
\cvpublication
	{(Accepted) \textbf{Costa, M.}, Manuel, M., Siebert, F. W., Azevedo, C. L., Moura, F. (2023). Scoring Cycling Environments Perceived Safety using Pairwise Image Comparisons. In 2023 IEEE International Conference on Intelligent Transportation Systems (ITSC). IEEE. Bilbao, Spain.}
%---------------------------------------------------------
\end{cvpublications}
